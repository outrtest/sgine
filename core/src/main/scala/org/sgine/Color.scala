...
object Color extends Enumerated[Color] {
  ...
  val DodgerBlue = immutable(0xff1e90f)
  ...
  val Honeydew = immutable(0xfff0ff0)
  ...
  val LavenderBlush = immutable(0xfffff05)
  ...
  val LightCyan = immutable(0xffe0fff)
  ...
  val LightSlateBlue = immutable(0xff8470f)
  ...
  val MediumSpringGreen = immutable(0xff00a9a)
  ...
  val Purple = immutable(0xffa0200)
  ...
  val SpringGreen = immutable(0xff00f7f)
