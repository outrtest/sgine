...
class AdvancedProperty[T] private(override implicit val manifest: Manifest[T]) extends MutableProperty[T] with DependentProperty[T] with ListenableProperty[T] with NamedProperty[T] with BindingProperty[T] with AnimatingProperty[T] with FilteredProperty[T] with StylizedProperty[T] {
